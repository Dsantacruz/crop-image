...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)('#cropper').draggable({ containment: '#container', drag: function drag() {
	    crop(cropper, img);
	  } });
	...
	document.getElementById('cropHeight').addEventListener('change', function (e) {
	  cropper.style.height = destCanvas.height = config.height = Number(e.target.value);
	});
	document.getElementById('cropWidth').addEventListener('change', function (e) {
	...
	var crop = function crop(cropper, image) {
	  ...
	  destCtx.drawImage(image, left, top, config.width, config.height, 0, 0, config.width, config.height);
	};
