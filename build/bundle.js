...
/***/ function(module, exports, __webpack_require__) {
	...
	var vm = new _vue2.default({
	  ...
	  ready: function ready() {
	    ...
	    this.cropper = (0, _jquery2.default)('#cropper');
	    this.cropper.draggable({ containment: '#container', drag: function drag() {
	        _this.crop();
	      } });
	  },
	  ...
	  methods: {
	    fileUpload: function fileUpload(e) {
	      ...
	      reader.onloadend = function () {
	        ...
	        _this2.img.onload = function () {
	          _this2.srcCanvas.width = _this2.srcCanvasStyle.width = _this2.img.naturalWidth;
	          _this2.srcCanvas.height = _this2.srcCanvasStyle.height = _this2.img.naturalHeight;
	          _this2.srcCanvas.getContext('2d').drawImage(_this2.img, 0, 0);
	          _this2.crop();
	        };
	      };
	    ...
	    crop: function crop() {
	      ...
	      this.destCtx.drawImage(this.img, pos.left, pos.top, this.config.width, this.config.height, 0, 0, this.config.width, this.config.height);
	    },
	...
	var update = function update(prop, newVal) {
	  this.destCanvas[prop] = newVal;
	  this.crop();
	};

	var createWatcher = function createWatcher(prop) {
